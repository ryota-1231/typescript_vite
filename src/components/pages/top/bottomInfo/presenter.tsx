    ...
    <StyledInfoContainer>
      ...
      <div css={'width: 30%;'}>
        ...
        <ul>
          <StyledInfoList>
            <StyledInfoSubject>
              <a href="https://ssl.tabelog.com/owner_account/login?lid=ownerlogin_rsttop_side">食べログ店舗会員ログイン</a>
            </StyledInfoSubject>
          ...
          <StyledInfoList>
            <StyledInfoSubject>
              <a href="https://owner.tabelog.com/owner_info/top?lid=ownerinfo_rsttop_side">無料で食べログに登録してお店をPRしましょう！</a>
            </StyledInfoSubject>
            <p css={'margin-top: 2px;'}>
        ...
        <ul>
          <StyledInfoList>
            <StyledInfoListLink href="https://campaign.tabelog.com/points/tpoint/">
              <StyledInfoListImageWrapper>
                <img css={'vertical-align: bottom;'} alt="" src="src/assets/images/top/top_banner_tpoint.png" height="45" width="45" />
              </StyledInfoListImageWrapper>
              <StyledInfoListDetail>
